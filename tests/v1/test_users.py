...
signup_payload = {"first_name": "catherine", "last_name": "faith", "other_name": "Were",
...
class TestUser(BaseTest):
    ...
    def test_existing_username(self):
            self.client.post(signup_url, data=json.dumps(signup_payload), content_type="application/json")
